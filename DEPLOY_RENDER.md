# Deploy Property Hub บน Render — **เลิกใช้แล้ว (แผนฟรีค้าง/หลับบ่อย)**

> **โฮสต์ปัจจุบันที่ควรใช้:** Fly.io — ดู [`DEPLOY_FLY.md`](DEPLOY_FLY.md)  
> แอดมินเปิดแค่ **https://hub.realxtateth.com/** (อย่าใช้ `*.onrender.com`)

เอกสารด้านล่างเก็บไว้เป็นประวัติ / ถ้าย้อนกลับชั่วคราว

---

## สิ่งที่เตรียมไว้ในโปรเจกต์แล้ว (legacy Render)
