...
def write_preview_js(projects: list[dict], properties: list[dict]) -> None:
    """Delegate to project_store so preview-data.js + meta stay versioned together."""
    from src.hub.project_store import write_preview_js as _write

    _write(projects, properties)
