...
allow={"HUB_USERS_JSON","HUB_SESSION_SECRET","GOOGLE_SERVICE_ACCOUNT_JSON","HUB_GOOGLE_SHEETS_ID","GOOGLE_SHEETS_ID","SOURCE_GOOGLE_SHEETS_ID","MAIN_SHEET_CSV_URL","MAIN_SHEET_GID","MAIN_SHEET_NAME","WAIT_POST_SHEET_CSV_URL","HUB_OVERVIEW_SHEET_NAME","HUB_SHEET_NAME","HUB_SHEET_GID","HUB_STARTUP_SHEET_SYNC","HUB_ALLOW_SHEET_PULL","HUB_AUTO_SYNC_TO_SHEET"}
for k,v in d.items():
    if k in allow and v is not None and str(v)!="":
        # shell-escape
        import shlex
        print(f"export {k}={shlex.quote(str(v))}")
print("export HUB_STARTUP_SHEET_SYNC=0")
print("export HUB_ALLOW_SHEET_PULL=0")
